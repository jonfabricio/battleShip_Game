...
class BattleShipPlayer(Player, ABC):
    ...
    def print_stats(self):
        num_wins = self.__stats[BattleShipResult.WIN]
        print(
    ...
    def event_result(self, pos: int, result: BattleShipResult):
